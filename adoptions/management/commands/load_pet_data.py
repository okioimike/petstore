...
from adoptions.models import Pet, Vaccines
    ...
    def handle(self, *args, **options):
        ...
        for row in DictReader(open('./pet_data.csv')):
            ...
            for vac_name in vaccination_names:
                vac = Vaccines.objects.get(name=vac_name)
